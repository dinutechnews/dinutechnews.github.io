...
async function fetchNews() {
    ...
    const mockNews = [
        { title: "AI Breakthrough: GPT-5 Announced", category: "AI", image: "https://images.unsplash.com/photo-1677442136019-21780ecad995", excerpt: "OpenAI reveals the next generation of language models with reasoning capabilities." },
        { title: "iPhone 16 Pro Leaks", category: "Mobile", image: "https://images.unsplash.com/photo-1511707171634-5f897ff02aa9", excerpt: "New titanium design and periscope lens confirmed for the upcoming flagship." },
        { title: "NVIDIA's New GPU Architecture", category: "Hardware", image: "https://images.unsplash.com/photo-1591488320449-011701bb6704", excerpt: "Blackwell architecture promises 5x performance leap in AI training." },
        { title: "SpaceX Starship Successful Launch", category: "Tech", image: "https://images.unsplash.com/photo-1517976487492-5750f3195933", excerpt: "The massive rocket reached orbit for the first time in historic test." },
        { title: "Android 15 Features Revealed", category: "Software", image: "https://images.unsplash.com/photo-1607252650355-f7fd0460ccdb", excerpt: "Google focuses on privacy and satellite connectivity in the next OS update." },
        { title: "Cyberpunk 2077 Sequel Teased", category: "Gaming", image: "https://images.unsplash.com/photo-1552820728-8b83bb6b773f", excerpt: "CD Projekt Red hints at Project Orion with new concept art." }
    ];
