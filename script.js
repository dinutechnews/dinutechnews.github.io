...
function updateThemeIcon() {
    const themeToggle = document.getElementById('theme-toggle');
    if (themeToggle) {
        themeToggle.innerHTML = state.theme === 'light' ? '🌙 Dark' : '☀️ Light';
    }
}
...
function initGiscusComments() {
    ...
    script.setAttribute('data-repo-id', 'R_kgDOAbCdEf');
    script.setAttribute('data-category', CONFIG.giscus.category);
    script.setAttribute('data-category-id', 'DIC_kwDOAbCdEf4BcDef');
